      ...
      <div className="space-y-6 pb-20">
        {devices.map((dev) => (
          <div key={dev.device} className="p-4 bg-zinc-900 rounded-xl shadow">
            ...
            <p className="text-sm text-zinc-400">{dev.sku}</p>
            ...
            <div className="flex gap-2 mb-3">
              <button
                onClick={() =>
                  sendCommand(dev.device, dev.sku, { name: "turn", value: "on" })
                }
              ...
              <button
                onClick={() =>
                  sendCommand(dev.device, dev.sku, {
                    name: "turn",
                    value: "off",
                  })
                }
              ...
              {Object.entries(presets).map(([name, hex]) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    sendColor(dev.device, dev.sku, hex);
                  }}
                />
              ))}
            </div>
            ...
            <div className="mt-2 mb-4">
              <input
                ...
                onChange={(e) => {
                  ...
                  sendBrightness(dev.device, dev.sku, v);
                }}
                className="w-full"
              />
